...
** Regarding CIM10 Device Configuration**

you need to generate this yml as json format or table format
...
for modbus coil writing
take any format for json generation xml or yml
deviceconfig:
  devices:
    - start_address: 1
      input_type: 4
      num_of_registers: "2"
      peripheral_name: Flowmeter
      interval: 100
      peripheral_id: "1234567891234567899"
      data_share: Query
      querycnt: 0
...
<deviceconfig>
  <devices>
    ...
    <num_of_registers>2</num_of_registers>
    <peripheral_name>Flowmeter</peripheral_name>
    <interval>100</interval>
    <peripheral_id>1234567891234567899</peripheral_id>
    ...
    <parameter>
      ...
      <property_name>PR1</property_name>
      <param>0</param>
      <isAddParam>false</isAddParam>
      <totalParam>0</totalParam>
      <uuid></uuid>
    </parameter>
    <parameter>
      <data_type>c</data_type>
      <adjustment_factor>1</adjustment_factor>
      <converter>n</converter>
      <property_name>PR2</property_name>
      <param>0</param>
      <isAddParam>false</isAddParam>
      <totalParam>0</totalParam>
      <uuid></uuid>
    </parameter>
    <isAddQuery>false</isAddQuery>
    <totQuery>0</totQuery>
    <queryinterval>1</queryinterval>
  </devices>
  <devicename>gg</devicename>
</deviceconfig>
